        ...
        <div className="container px-4 md:px-8 max-w-7xl mx-auto py-8">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground font-medium md:text-lg tracking-tight mt-2 max-w-2xl">
              <span className="font-bold text-foreground"> +{`1 329`} </span>{" "}
              produits, apps, SaaS et outils construits par des makers de
              Madagascar. Découvrez, votez, et soutenez la scène locale.
            </p>
          </div>
