...
// TODO(auth + middleware): role-gate ici — session requise + role=admin,
// sinon redirect /signin ou 403. Jamais de gate client-only : le middleware
// /admin/:path* + ce double-check server font la défense en profondeur.
