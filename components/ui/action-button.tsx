...
export function ActionButton({ 
  ...
  const base = "inline-flex items-center justify-center gap-2 h-12 px-7 rounded-full font-semibold text-[15px] transition-all duration-300 ease-out active:scale-[0.98] hover:-translate-y-0.5 cursor-pointer";
  ...
  const variants = {
    ...
    outline: "bg-background border-2 border-border text-foreground hover:border-foreground/30 hover:bg-muted/50 shadow-sm",
  }
