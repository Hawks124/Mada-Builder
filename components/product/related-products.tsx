...
const PRODUCTS = [
  {
    id: "abono",
    name: "Abono",
    tag: "Split bills, not friendships.",
    icon: "bg-blue-500",
    rating: "4.9",
    votes: 311,
    maker: "Glenn Joshua",
  ...
  },
  {
    ...
    tag: "Generate invoices fast.",
    icon: "bg-orange-500",
    rating: "5.0",
    votes: 89,
    maker: "Andry Rakoto Ramarolahy",
    verified: true,
  },
];
        ...
        {PRODUCTS.map((p) => (
          ...
          >
            ...
            <div className="flex items-start justify-between">
              <div
                className={cn(
                  "w-14 h-14 rounded-2xl shrink-0 relative overflow-hidden shadow-sm transition-transform duration-300 group-hover:scale-105 group-hover:-rotate-2",
                  p.icon,
                )}
              >
